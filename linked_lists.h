...
ll_node_t* ll_append( ll_node_t** head,  ll_node_t* node);
/// <summary>
...
ll_node_t* ll_remove(ll_node_t** head, ll_node_t* node);
/// <summary>
/// Revert the list
/// </summary>
/// <param name="head">: reference to the "head" node of the list</param>
...
#define ll_list_append_string(head, item) ll_append((ll_node_t**)head,(ll_node_t *)ll_string_item_new(item));
#define ll_string_item_list_free(head) ll_list_free((ll_node_t**)head)
